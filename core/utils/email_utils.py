...
def send_voting_link_email(nominee, request=None):
    ...
    site_name = site_settings.site_name if site_settings else 'BEACON OF EXCELLENCE AWARDS'
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f7f6; padding: 20px;">
            <tr>
                <td align="center">
                    <div class="container">
                        <div class="header">
                            <h1>BEACON OF EXCELLENCE AWARDS</h1>
                            <div class="subtitle">AWARDS AFRICA</div>
                        </div>
                        <div class="body">
                            <h2>Hello {nominee.get_display_name()},</h2>
                            <p>
                                You have been successfully nominated for the <strong>{nominee.category.name}</strong> category at the <strong>BEACON OF EXCELLENCE AWARDS</strong>.
                            </p>
                            <p>
                        ...
                        <div class="footer">
                            <p>&copy; {timezone.now().year} BEACON OF EXCELLENCE AWARDS. All rights reserved.</p>
    ...
    You have been successfully nominated for the {nominee.category.name} category at the BEACON OF EXCELLENCE AWARDS.
