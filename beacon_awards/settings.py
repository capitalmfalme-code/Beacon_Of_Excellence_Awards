...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-beacon-awards-2026-change-this-in-production'
)
...
ROOT_URLCONF = 'beacon_awards.urls'
...
WSGI_APPLICATION = 'beacon_awards.wsgi.application'
ASGI_APPLICATION = 'beacon_awards.asgi.application'
...
DEFAULT_FROM_EMAIL = os.environ.get(
    'DEFAULT_FROM_EMAIL',
    EMAIL_HOST_USER or 'Beacon Of Excellence Awards <noreply@pinnacleexcellenceawards.com>'
)
...
# STARTUP BANNER
# ============================================================
print(f"🚀 Beacon Of Excellence Awards starting — DEBUG={DEBUG}")
